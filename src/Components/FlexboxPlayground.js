...
class Flexboxplayground extends Component {
  ...
  onChange = async (e) => {
    ...
    switch (
      param //sending the target input as params
    ) {
      case "display":
    ...
    return (
      <>
        <div>
          ...
          <select value={display} name="display" onChange={this.onChange}>
          ...
          <select value={flexWrap} name="flexWrap" onChange={this.onChange}>
          ...
          <select value={alignItems} name="alignItems" onChange={this.onChange}>
            <option value="flex-start">flex-start</option>
            <option value="flex-end">flex-end</option>
            <option value="center">center</option>
            <option value="space-around">space-around</option>
