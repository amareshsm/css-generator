  ...
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="mr-auto">
      ...
      <NavDropdown title="css generators" id="basic-nav-dropdown">
        ...
        <NavDropdown.Item  href="/BorderRadius">BorderRadius</NavDropdown.Item>
        <NavDropdown.Item href="/TextShadow">TextShadow</NavDropdown.Item>
        <NavDropdown.Item href="/FlexBoxGenerator">Flex Box Generator</NavDropdown.Item>
        <NavDropdown.Item href="/Margin">Margin and Padding</NavDropdown.Item>
